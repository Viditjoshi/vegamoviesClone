...
const Header = () => {
  ...
  const handleToggleSearch = () => {
    ...
    document.querySelector(".mob__nav__searchBar").className.includes("active")
      ? document.querySelector("#mobSearch").focus()
      : document.querySelector("#mobSearch").blur();
  };

  return (
    <header className="header">
      <Link to="/">
        <img src={logo} alt="Logo" className="d-block header__logo" />
      </Link>
      <nav className="nav">
        <ul>
          ...
          <li className={pathname === "/popular" ? "active" : ""}>
            <Link to="/popular">Popular</Link>
          </li>
          <li className={pathname === "/upcomming" ? "active" : ""}>
      ...
      <nav className="mob__nav">
        <div className="mob__nav__header">
          <span
            onClick={() => {
              document
                .querySelector(".mob__nav__bar")
                .classList.toggle("active");
            }}
            className="mob__nav__toggleBtn"
          >
            <MenuIcon />
          </span>
          {/* <MenuIcon /> */}
          <Link to="/">
            <img src={logo} alt="Logo" className="mob__header__logo" />
          </Link>
          <span onClick={handleToggleSearch} className="mob__nav__toggleBtn">
            <SearchIcon />
          </span>
        </div>
        <div className="mob__nav__bar ">
          <span
            ...
            className="mob__nav__toggleBtn"
          >
            <CloseIcon className="mob__nav__bar__closeBtn" />
          </span>
          <ul>
            <li className={pathname === "/" ? "active" : ""}>
              <Link
        ...
        <div className="mob__nav__searchBar">
          <form onSubmit={handleSearch} className="mob__nav__search__form">
            <input
              ...
              onBlur={() => {
                document
                  .querySelector(".mob__nav__searchBar")
                  .classList.remove("active");
              }}
              onChange={(e) => {
                setQeury(e.target.value);
              ...
              id="mobSearch"
              className="mob__nav__search"
              placeholder="Search..."
            />
            <button
              className="mob__nav__searchBtn"
              type="submit"
              disabled={query.length <= 0}
            >
              <SearchIcon />
